= X12 and EDIFACT Connectors Release Notes
...
This release fixes a number of issues in both EDIFACT and X12 EDI Connectors.

EDIFACT EDI Connector:

* Fix infinite loop when missing UNT segment. (SE-10442)
* Add specific error message when missing UNT segment. (SE-10442)
* Support integer value types for implied decimal format. (SE-11494)
* Correct escape character handling on read. (SE-9795)
* Eliminate NPE when space value set for delimiter character. (SE-11312)
* Change shaded pacakge name for debugger compatibility. (SE-10796)

X12 EDI Connector:

* Support integer value types for implied decimal format. (SE-11494)
* Correctly handle multiple HIPAA transaction sets in a group. (SE-9043)
* Identify the ISA segment when it's the cause of a write error. (SE-10796)
* Change shaded pacakge name for debugger compatibility. (SE-10796)
* Add transaction set information to error message for schema not found. (SE-7935)

=== Compatibility

EDIFACT EDI Connector v1.3.3 is compatible with the following:
...
X12 EDI Connector v1.3.3 is compatible with the following:
